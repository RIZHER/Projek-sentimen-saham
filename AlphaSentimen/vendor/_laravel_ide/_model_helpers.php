...
namespace App\Models {
     ...
     * @property string|null $sentimen
     * @property string $isi_berita
     * @property string $judul_berita
     * @property string $url
     * @property int $saham_id
     * @property int $berita_id
     * @property-read \App\Models\SahamProfile $sahamProfile
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereBeritaId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereSahamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereJudulBerita($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereIsiBerita($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Berita>|Berita whereSentimen($value)
    ...
    /**
     * App\Models\Postingan
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string $status
     * @property string $isi_postingan
     * @property string $judul_postingan
     * @property int $user_id
     * @property int $saham_id
     * @property int $postingan_id
     * @property-read \App\Models\SahamProfile $sahamProfile
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan wherePostinganId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereSahamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereJudulPostingan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereIsiPostingan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Postingan>|Postingan query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Postingan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\SahamProfile
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $sentimen
     * @property string $nama_saham
     * @property string $kode_saham
     * @property int $saham_id
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereSahamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereKodeSaham($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereNamaSaham($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereSentimen($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<SahamProfile>|SahamProfile query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class SahamProfile extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
